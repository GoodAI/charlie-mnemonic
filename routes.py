...
async def register(user: User, response: Response):
    ...
    if session_token:
        response.set_cookie(key="session_token", value=session_token, secure=isOnHttps, httponly=False, samesite="None", max_age=360000)
        response.set_cookie(key="username", value=user.username, secure=isOnHttps, httponly=False, samesite="None", max_age=360000)
